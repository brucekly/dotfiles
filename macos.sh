...
sudo scutil --set ComputerName "andromeda"
sudo scutil --set HostName "andromeda"
...
# Remove titlebar rollover delay
...
# Automatically quit printer app once print jobs are finished
